...
class WooCommerce
{
     ...
     */
    public function understrap_woocommerce_support()
    {
        ...
        add_filter('woocommerce_form_field_args', array($this, '_wc_form_field_args'), 10, 3);
    }
     ...
     * @return mixed
     */
    public function _wc_form_field_args($args, $key, $value = null)
    {
...
// ---------------------------------------------
    ...
    public function _disable_woocommerce_loading_css_js()
    {
