...
class Tags
{
   public static function understrap_posted_on() {
     ...
     */
  public static function understrap_entry_footer() {
        // Hide category and tag text for pages.
        if ( 'post' === get_post_type() ) {
            /* translators: used between list items, there is a space after the comma */
            $categories_list = get_the_category_list( esc_html__( ', ', 'understrap' ) );
            if ( $categories_list && self::understrap_categorized_blog() ) {
     ...
     * @return bool
     */
  public static function understrap_categorized_blog() {
