...
class Comments
{
    ...
    {
        add_filter('comment_form_defaults', array($this, '_bootstrap_comment_form'));
        add_filter('comment_form_default_fields', array($this, '_bootstrap_comment_form_fields'));
    }
     ...
     * @return array
     */
    function _bootstrap_comment_form_fields($fields)
    {
     ...
     * @return mixed
     */
    public function _bootstrap_comment_form($args)
    {
