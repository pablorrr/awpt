                ...
                <main class="site-main" id="main">
                    ...
                    <section class="error-404 not-found">
                        ...
                        <div class="page-content">
                            ...
                            <?php if (method_exists(' Awpt\Core\Tags', 'understrap_categorized_blog')):
                                if (Awpt\Core\Tags::understrap_categorized_blog())  : // Only show the widget if site has multiple categories.
                                    ?>
